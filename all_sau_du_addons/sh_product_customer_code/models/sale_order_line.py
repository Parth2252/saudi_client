...
class SaleOrderLine(models.Model):
    ...
    #                         ("name", "in", partners),
    #                         "|",
    #                         ("offered_description_id", "=", line.offered_description_id.id),
    ...
    #                 )
    #             )
    #             line.sh_line_customer_code = (
    #                 customer_code.product_code
    #                 if customer_code and customer_code.product_code
    #                 else False
    #             )
    #             line.sh_line_customer_product_name = (
    #                 customer_code.product_name
    #                 if customer_code and customer_code.product_name
    #                 else False
    #             )
    #
    #             if self.offered_description_id and customer_code:
    #                 des = " "
    #
